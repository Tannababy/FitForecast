let savedExerciseTitle = localStorage.getItem("savedExerciseTitle") ? JSON.parse(localStorage.getItem("savedExerciseTitle")) : [];
let savedExerciseInstructions = localStorage.getItem("savedExerciseInstructions") ? JSON.parse(localStorage.getItem("savedExerciseInstructions")) : [];
let savedExerciseGif = localStorage.getItem("savedExerciseGif") ? JSON.parse(localStorage.getItem("savedExerciseGif")) : [];
...
savedExerciseTitle = savedExerciseTitle.reverse();
savedExerciseInstructions = savedExerciseInstructions.reverse();
savedExerciseGif = savedExerciseGif.reverse();
